...
public class RegistrationPage extends BasePage {
    ...
    public void clickSubmit() {
        scrollToTheBottom(TestValues.submitButton);
        javaScriptClick(TestValues.submitButton);
    }

    public RegistrationPage verifyPasswordsDoNotMatch(String expectedError) {
        String actualError = readText(TestValues.passwordConfirmMissTextField);
    ...
    public RegistrationPage verifyPasswordConfirmMissing(String expectedMissingPasswordConfirmText) {
        ...
        assertTextEquals(TestValues.passwordConfirmMissText, actualMissingPasswordConfirmText);
        return this;
    }
    ...
    public void acceptCookieIfVisible() {
        try {
            click(TestValues.cookieConsent);
        } catch (TimeoutException exception) {
            System.out.println("Cookie element is not visible, test continued.");
        }
    }
}